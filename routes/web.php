            ...
            if ($conversation->acheteur_id === $userId || ($conversation->produit && $conversation->produit->vendeur_id === $userId)) {
                ...
                if ($partner) {
                    ...
                    $preloadedConversation = [
                        ...
                        'partner_pfp'    => $partner->pfp ? \App\Helpers\ImageHelper::getUrl($partner->pfp) : 'https://ui-avatars.com/api/?name=' . urlencode($partner->name ?? 'U'),
                        'auth_pfp'       => auth()->user()->pfp ? \App\Helpers\ImageHelper::getUrl(auth()->user()->pfp) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name ?? 'U'),
