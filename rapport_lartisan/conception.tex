...
\begin{itemize}
    ...
    \item \textbf{Ergonomie et Accessibilité (UX/UI)} : Interface \textit{Mobile-First}, garantissant une utilisation fluide sur smartphones, tablettes et ordinateurs de bureau.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{mct.pdf}
