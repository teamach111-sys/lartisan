# L'Artisan — Product & Marketplace Feature

> This gist covers Categories, Product Creation, Display, and the Dashboard (Annonces).
...
*(Form with `enctype="multipart/form-data"` and `images[]` input for 5 files)*

### `resources/views/produit/show.blade.php`
*(Alpine.js gallery for images, Seller Info, "Contact Seller" Form)*

### `resources/views/annonces.blade.php`
*(Dashboard view iterating over `$userProduits`)*

> ***Note:** View full HTML templates in `FULL_SITE_GIST.md`.*
