...
<head>
    ...
    <title>Réinitialiser le mot de passe - Lartisan</title>
            ...
            <div class="flex flex-col w-full lg:w-1/2 p-4 sm:p-8 md:p-12 pt-6">
                <div class="flex justify-between items-start w-full mb-6 sm:mb-10">
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="text-[10px] sm:text-xs font-bold text-gray-400 uppercase tracking-widest">Nouveau mot
                            de passe</p>
                    </div>
                ...
                <div
                    ...
                    <p class="text-gray-500 text-xs sm:text-sm mb-6 border-b border-black pb-4">Choisissez un nouveau
                        mot de passe sécurisé pour votre compte.</p>
                    ...
                    <form action="{{ route('password.update') }}" method="POST" class="space-y-4 sm:space-y-6">
                        ...
                        <div class="flex flex-col gap-1 sm:gap-2">
                            ...
                            <input name="email" id="email" type="email" value="{{ $email ?? old('email') }}"
                                required readonly
                        ...
                        <div class="flex flex-col gap-1 sm:gap-2">
                            <label class="font-bold text-xs sm:text-sm uppercase tracking-wider" for="password">Nouveau
                                mot de passe</label>
                        ...
                        <div class="flex flex-col gap-1 sm:gap-2">
                            <label class="font-bold text-xs sm:text-sm uppercase tracking-wider"
                                for="password_confirmation">Confirmer</label>
