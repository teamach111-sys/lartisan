                ...
                <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data" class="flex md:grid md:grid-cols-2 flex-col xl:grid  xl:grid-cols-2 lg:p-5 xl:p-18 p-6 gap-2">
                    ...
                    @endif
                     <div  class="flex flex-col">
                        ...
                        <input name="name" class="focus:shadow-[0_0_0_2px_#fb663f] outline-none bg-white border rounded-sm h-13 text-[20px]" type="text" id="nom"
                            >

                    </div>
                    <div class="flex flex-col">
                        <label class="text-[17px]" for="email">Email</label>
                        <input name="email" class="focus:shadow-[0_0_0_2px_#fb663f] outline-none bg-white border rounded-sm h-13 text-[20px]" type="email" id="email"
                            >

                    </div>
                    <div  class="flex flex-col">
                        <label class="text-[17px]" for="password">Mot de passe</label>
                        <input name="password" class="focus:shadow-[0_0_0_2px_#fb663f] outline-none bg-white border rounded-sm h-13 text-[20px]" type="password" id="password"
                            >

                    </div>
                    <div  class="flex flex-col">
                        <label class="text-[17px]" for="password_confirmation">Confirmer le mot de passe</label>
                        <input name="password_confirmation" class="focus:shadow-[0_0_0_2px_#fb663f] outline-none bg-white border rounded-sm h-13 text-[20px]" type="password" id="password_confirmation"
                            >

                    </div>
                    <div  class="flex flex-col">
                        <label class="text-[17px]" for="tel">Numéro de téléphone</label>
                        <input name="telephone" class="focus:shadow-[0_0_0_2px_#fb663f] outline-none bg-white border rounded-sm h-13 text-[20px]" type="tel" id="tel"
                            >

                    </div>
                     <div  class="flex flex-col">
                        <label class="text-[17px]" for="ville">Ville</label>
                        <select class="focus:shadow-[0_0_0_2px_#fb663f] outline-none bg-white border rounded-sm h-13 text-[20px]" name="ville_utilisateur" id="ville">
                     ...
                     <div  class="flex flex-col">
                        ...
                        <input name="pfp" id="profil" class="" type="file" id="profil"
                            >
