...
<head>
    ...
    <title>Mot de passe oublié - Lartisan</title>
            ...
            <div class="flex flex-col w-full lg:w-1/2 p-4 sm:p-8 md:p-12 pt-6">
                <div class="flex justify-between items-start w-full mb-6 sm:mb-10">
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="text-[10px] sm:text-xs font-bold text-gray-400 uppercase tracking-widest">Récupération
                            de compte</p>
                    </div>
                ...
                <div
                    ...
                    <p class="text-gray-500 text-xs sm:text-sm mb-6 border-b border-black pb-4">Entrez votre email et
                        nous vous enverrons un lien pour réinitialiser votre mot de passe.</p>

                    @if (session('status'))
                        <div
                            class="bg-green-100 border border-green-500 text-green-700 px-4 py-3 rounded-sm mb-6 font-bold text-sm">
                    ...
                    <form action="{{ route('password.email') }}" method="POST" class="space-y-4 sm:space-y-6">
                        ...
                        <div class="flex flex-col gap-1 sm:gap-2">
                            <label class="font-bold text-xs sm:text-sm uppercase tracking-wider" for="email">Adresse
                                email</label>
