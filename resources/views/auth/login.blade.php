        ...
        <div class="flex justify-between">
            <div class="flex flex-col w-full">
                <div class="flex  justify-between w-full px-3">
                    <div class="">
                        <img class="h-30" src="{{ asset('storage/logo.svg') }}" alt="">

                    </div>
                    <a class="mt-3" href="">Inscription</a>
                ...
                <form action="POST" class="flex flex-col lg:p-13 xl:p-18 p-7 pt-10 xl:pt-26 gap-6">
                    <div class="flex flex-col">
                        <label class="text-[17px]" for="email">Email</label>
                        <input
                            class="focus:shadow-[0_0_0_2px_#fb663f] outline-none bg-white border rounded-sm h-13 text-[30px]"
                            type="email" id="email">
