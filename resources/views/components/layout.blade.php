...
<body class="w-full bg-[#F4F4F0]">
  <div class="bg-[#F4F4F0] max-w-[1800px] mx-3 lg:mx-14">
    <nav class="lg:flex gap-5 lg:h-29 h-auto items-center justify-between py-1  mt-1  ">
      ...
      <img class="lg:h-full h-auto max-h-20  shrink-0 " src="make-text-logo--lartisan----black-text-and-no-icon (1).svg" alt="">
  ...
  <div class=" hidden lg:block lg:h-auto max-w-[1800px] mx-14 lg:flex justify-between">
    ...
    hover:text-black" href="">Menuiserie</a>
     ...
     <div>
      <img class="h-10 w-10 object-cover rounded-[50px] hover:border hover:border-[#fb663f] cursor-pointer" src="https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=800&h=600&fit=crop">
     </div>
