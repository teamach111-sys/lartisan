# L'Artisan — Filament Admin Gist

> **Copy-paste ready.**  
> Covers: Users, Produits, Catégories, Signalements, and Dashboard Stats.  
...
### `app/Models/User.php` — Allow only admins
*Ensure your User model has these traits and method:*
```php
...
## STEP 2 — Categorie Resource

> **Run command:** `php artisan filament:resource Categorie`

### `app/Filament/Resources/Categories/CategorieResource.php`
```php
<?php
...
### `app/Filament/Resources/Categories/Schemas/CategorieForm.php`
*Create this file if it doesn't exist, and update Resource to use it.*
```php
<?php
...
> **Run command:** `php artisan filament:resource User`
...
## STEP 4 — Produit Resource

> **Run command:** `php artisan filament:resource Produit`

### `app/Filament/Resources/Produits/ProduitResource.php`
```php
<?php
...
### `app/Filament/Resources/Produits/Schemas/ProduitForm.php`
```php
<?php
...
## STEP 5 — Signalement Produit (Reports) Resource

> **Run command:** `php artisan filament:resource SignalementProduit`

### `app/Filament/Resources/SignalementProduits/SignalementProduitResource.php`
```php
<?php
...
### `app/Filament/Resources/SignalementProduits/Schemas/SignalementProduitForm.php`
```php
<?php
...
### `app/Filament/Resources/SignalementProduits/Tables/SignalementProduitsTable.php`
```php
<?php
...
## STEP 6 — Dashboard Stats Widget

> **Run command:** `php artisan filament:widget StatsOverview --type=stats-overview`
